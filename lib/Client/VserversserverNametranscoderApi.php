<?php
/**
 * VserversserverNametranscoderApi
 * PHP version 5
 *
 * @category Class
 * @package  WowzaApi
...
/**
 * VserversserverNametranscoderApi Class Doc Comment
 *
 * @category Class
 * @package  WowzaApi
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VserversserverNametranscoderApi extends SwaggerApi
{
     ...
     */
    public function getTranscoderConfig($serverName)
    {
        list($response) = $this->getTranscoderConfigWithHttpInfo($serverName);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response
     */
    public function getTranscoderConfigWithHttpInfo($serverName)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), TranscoderConfig::class, $e->getResponseHeaders());
