...
/**
 * SDPFilesAppConfig Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SDPFilesAppConfig extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SDPFilesAppConfig';
    ...
    {
        $this->container['sdpFiles'] = isset($data['sdpFiles']) ? $data['sdpFiles'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sdpFiles'] === null) {
            $invalid_properties[] = "'sdpFiles' can't be null";
        }
     ...
     * @return  ShortObject[]
     */
    public function getSdpFiles()
    {
        return $this->container['sdpFiles'];
    }

    /**
     * Sets sdpFiles
     * @param ShortObject[] $sdpFiles
     * @return $this
     */
    public function setSdpFiles($sdpFiles)
    {
        $this->container['sdpFiles'] = $sdpFiles;
