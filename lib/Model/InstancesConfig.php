...
/**
 * InstancesConfig Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InstancesConfig extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstancesConfig';
    ...
    protected static $swaggerTypes = array(
        'instanceList' => InstanceConfig::class.'[]',
        'serverName' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instanceList'] === null) {
            $invalid_properties[] = "'instanceList' can't be null";
        }
    ...
    /**
     * Sets instanceList
     * @param InstanceConfig[] $instanceList
     * @return $this
     */
