...
/**
 * PushPublishStreamsAppConfig Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PushPublishStreamsAppConfig extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PushPublishStreamsAppConfig';
    ...
    protected static $swaggerTypes = array(
        'mapEntries' => PushPublishStreamAppConfig::class.'[]',
        'serverName' => 'string',
    ...
    {
        $this->container['mapEntries'] = isset($data['mapEntries']) ? $data['mapEntries'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mapEntries'] === null) {
            $invalid_properties[] = "'mapEntries' can't be null";
        }
    ...
    {
        return $this->container['mapEntries'];
    }

    /**
     * Sets mapEntries
     * @param PushPublishStreamAppConfig[] $mapEntries
     * @return $this
     */
    public function setMapEntries($mapEntries)
    {
        $this->container['mapEntries'] = $mapEntries;
