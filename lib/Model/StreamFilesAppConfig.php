...
/**
 * StreamFilesAppConfig Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StreamFilesAppConfig extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StreamFilesAppConfig';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['streamFiles'] = isset($data['streamFiles']) ? $data['streamFiles'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['streamFiles'] === null) {
            $invalid_properties[] = "'streamFiles' can't be null";
        }
     ...
     * @return  ShortObject[]
     */
    public function getStreamFiles()
    {
        return $this->container['streamFiles'];
    }

    /**
     * Sets streamFiles
     * @param ShortObject[] $streamFiles
     * @return $this
     */
    public function setStreamFiles($streamFiles)
    {
        $this->container['streamFiles'] = $streamFiles;
