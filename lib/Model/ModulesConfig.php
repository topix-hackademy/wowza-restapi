...
/**
 * ModulesConfig Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModulesConfig extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModulesConfig';
    ...
    {
        $this->container['moduleList'] = isset($data['moduleList']) ? $data['moduleList'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['moduleList'] === null) {
            $invalid_properties[] = "'moduleList' can't be null";
        }
    ...
    {
        return $this->container['moduleList'];
    }

    /**
     * Sets moduleList
     * @param ModuleConfig[] $moduleList
     * @return $this
     */
    public function setModuleList($moduleList)
    {
        $this->container['moduleList'] = $moduleList;
