...
/**
 * SourceDriverNamesList Class Doc Comment
 *
 * @category    Class
 * @package     WowzaApi
 * @author      http://github.com/swagger-api/swagger-codegen
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SourceDriverNamesList extends SwaggerModel
 {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceDriverNamesList';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['list'] === null) {
            $invalid_properties[] = "'list' can't be null";
        }
