...
namespace Topix\Hackademy\WowzaApi;
...
class Configuration
{
    ...
    public static $DEFAULT_SERVER = '_defaultServer_';
    public static $DEFAULT_VHOST = '_defaultVHost_';
    public static $DEFAULT_INSTANCE = '_definst_';


    public static $BASIC_AUTH = "BASIC_AUTH";
    public static $APY_KEYS = "API_KEYS";
     ...
     * @var string
     */
    protected $host = 'http://localhost:8087/';
    ...
    public function __construct()
    {
        ...
        $this->authentication = self::$BASIC_AUTH;
    }
    ...
    {
        $report  = "PHP SDK (WowzaApi) Debug Report:".PHP_EOL;
