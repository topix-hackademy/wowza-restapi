<?php
/**
 * VmachinemonitoringhistoricApiTest
 * PHP version 5
 *
 * @category Class
 * @package  WowzaApi
...
use Topix\Hackademy\WowzaApi\Client\VmachinemonitoringhistoricApi;

/**
 * VmachinemonitoringhistoricApiTest Class Doc Comment
 *
 * @category Class
 * @package  WowzaApi
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VmachinemonitoringhistoricApiTest extends TestCase
{
    ...
    public function it_should_throw_an_exception()
    {
        ...
        $api_instance = new VmachinemonitoringhistoricApi();
    ...
    {
        try {
            $api_instance = new VmachinemonitoringhistoricApi($this->apiClient);
            $result = $api_instance->getHistoricMachineStatistics();
